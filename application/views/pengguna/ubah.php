                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('pengguna/proses_ubah/' . $pengguna->kode) ?>"
                                        id="form-tambah" method="POST">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="kode"><strong>Kode Pengguna</strong></label>
                                                <input type="text" name="kode" placeholder="Masukkan Kode Pengguna"
                                                    autocomplete="off" class="form-control" required
                                                    value="<?= $pengguna->kode ?>" maxlength="8" readonly>
                                            </div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="role_akses"><strong>Role Akses</strong></label>
                                                <select name="role_akses" id="role_akses" class="form-control" required>
                                                    <option value="">Silahkan Pilih</option>
                                                    <option value="01"
                                                        <?= $pengguna->kode_role == '01' ? 'selected' : '' ?>>Admin
                                                    </option>
                                                    <option value="02"
                                                        <?= $pengguna->kode_role == '02' ? 'selected' : '' ?>>Kasir
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
